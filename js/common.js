        const url = 'http://172.16.100.12:5003/api';
        ...
        //调用post方法 ；string方法名url；json传递参数；function 返回方法
        function goWebApiPost(methodName, paramTag, callback) {
        ...
        //调用get方法;string 方法名后缀加url为修改，返回函数
        function goWebApiGet(methodName,callback) {
            console.info(methodName);
            $.ajax({
                url: methodName,
                type: "get",
        ...
        //调用delete方法 string方法名url后缀加/{id};function 返回方法
        function goWebApiDelete(methodName, callback) {
            console.info(methodName);
            $.ajax({
                url: methodName,
                type: "delete",
        ...
        //调用put方法 ；string方法名url；json传递参数；function 返回方法
        function goWebApiPut(methodName, paramTag, callback) {
            console.info(methodName);
            console.log(JSON.stringify(paramTag));
            $.ajax({
                url: methodName,
